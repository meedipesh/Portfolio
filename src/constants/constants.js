...
export const TimeLineData = [
  { year: 2018, text: 'Worked intensively on Web Apps.', },
  { year: 2019, text: 'Joined Islington College for Bachelors in IT', },
  { year: 2020, text: 'Learned Flutter for app development.', },
  { year: 2021, text: 'Completed Bachelors in IT from Islington College.', },
  // { year: 2022, text: 'Got a scholarship from the Delhi government.', },
